...
#Taken from the pymice library and modified to fit the specific utility in this project of Transit Dataset Imputation
...
class MultivariateAmputation(TransformerMixin):
    ...
    def _choose_probabilities(self, wss, i):
        ...
        # else we calculate the probabilities based on the wss
            ...
            wss_standardized = scaler.fit_transform(wss)
    ...
    def _calculate_sumscores(self, data_group, i):
        ...
        if self.std:
            scaler = StandardScaler()
            #data_group = stats.zscore(data_group, axis=None)
    ...
    def fit_transform(self, X):
        ...
        for i in range(self.patterns.shape[0]):
            ...
            print('test')
            data_group = X.iloc[group_indices,:]
